...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'iamshuklajai@gmail.com', // gmail
...
exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"Swift-Cart" <iamshuklajai@gmail.com>', // sender address
        to,
        subject,
        text,
        html
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                <img src="https://cdn3d.iconscout.com/3d/premium/thumb/cart-5590713-4652405.png" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
